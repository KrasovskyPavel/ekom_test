...
export const Display: FC<Props> = ({ firstNumber, secondNumber, operator, answer }) => {
  ...
  return (
    <div className="relative isolate mb-2 flex flex-1 flex-col items-end justify-end px-5">
      <div className="max-w-full rounded text-right font-bold text-slate-800">
        <div className="text-right text-[30px]  text-[#D2D3DA] ">
          <ScrollBlock
            theme="dark"
        ...
        <ScrollBlock
          theme="dark"
          className="min-h-[56px] overflow-hidden pb-2 text-end  text-[70px]"
          forceChildAlignEnd
        >
          {mainDisplay}
        </ScrollBlock>
