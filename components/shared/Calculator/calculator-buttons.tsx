...
interface Props {
  ...
  initButton: (rowIdx: number, columnIdx: number, ref: RefObject<HTMLButtonElement>) => void;
}
...
export const CalculatorButtons = ({
  ...
  return (
    <div className="grid grid-cols-4 grid-rows-5 gap-2 rounded-t-3xl p-5 min-h-[450px]">
